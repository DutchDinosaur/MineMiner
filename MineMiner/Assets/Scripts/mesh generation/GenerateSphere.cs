...
public class GenerateSphere : MonoBehaviour
{
    ...
    void GenerateMesh()
    {
        Vector3[] vertices = new Vector3[resolution * resolution * 4];
        Vector3[] normals = new Vector3[resolution * resolution * 4];
        int[] triangles = new int[(resolution - 1) * (resolution - 1) * 6 * 4];
        int triIndex = 0;
